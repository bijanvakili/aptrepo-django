...
def get_repository_controller(logger=None, user=None, request=None, sys_user=False):
    """
    ...
    """
    import repository
    return repository.Repository(logger=logger, user=user, request=request, sys_user=sys_user)
